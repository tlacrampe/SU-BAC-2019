...
```{r}
zoneAmonth$avg_actual_MAX_TEMP = ts(zoneAmonth$avg_actual_MAX_TEMP, frequency = 12)
autoplot(zoneAmonth$avg_actual_MAX_TEMP)
zoneAmonth$cumPeakLoad = ts(zoneAmonth$cumPeakLoad, frequency = 12)
autoplot(zoneAmonth$cumPeakLoad)
zoneAmonth$maxPeakLoad = ts(zoneAmonth$maxPeakLoad, frequency = 12)
...
fcastArimaMonthlyMaxTempA = forecast(arimaMonthlyMaxTempA, h = 144)
...
fcastArimaMonthlyCumeLoadA = forecast(arimaMonthlyCumeLoadA, h = 144, xreg = fcastArimaMonthlyMaxTempA$mean)
plot(fcastArimaMonthlyCumeLoadA)

# let's try with the upper 85% confidence interval
fcastArimaMonthlyCumeLoadA = forecast(arimaMonthlyCumeLoadA, h = 144, xreg = fcastArimaMonthlyMaxTempA$upper[,1])
...
fcastArimaMonthlyPeakLoadA = forecast(arimaMonthlyPeakLoadA, h = 144, xreg = fcastArimaMonthlyMaxTempA$mean)
...
fcastArimaMonthlyPeakLoadAWithoutTemp = forecast(arimaMonthlyPeakLoadAWithoutTemp, h = 144)
plot(fcastArimaMonthlyPeakLoadAWithoutTemp) # doesnt change much

# what if we do the logs?

zoneAmonth$logMaxPeakLoad = log(zoneAmonth$maxPeakLoad)
arimaMonthlyPeakLoadAlog = auto.arima(zoneAmonth$logMaxPeakLoad, xreg = zoneAmonth$avg_actual_MAX_TEMP)
summary(arimaMonthlyPeakLoadAlog)
fcastArimaMonthlyPeakLoadAlog = forecast(arimaMonthlyPeakLoadAlog, h = 144, xreg = fcastArimaMonthlyMaxTempA$mean)
